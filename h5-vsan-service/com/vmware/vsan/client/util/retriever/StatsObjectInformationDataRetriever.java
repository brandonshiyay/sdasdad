...
class StatsObjectInformationDataRetriever extends AbstractAsyncDataRetriever {
   public StatsObjectInformationDataRetriever(ManagedObjectReference clusterRef, Measure measure, VsanClient vsanClient) {
