...
public class VmfsVmCapacityCalculator extends VmCapacityCalculator {
   public VmfsVmCapacityCalculator(CapacityObjectsAccessor capacityObjectsAccessor) {
   ...
   public VmCapacityData calculate() {
      ...
      result.datastoreType = DatastoreType.VMFS;
      return result;
   }
}
